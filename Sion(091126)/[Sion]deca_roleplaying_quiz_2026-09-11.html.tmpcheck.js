var TITLE = "[Sion] Deca Role playing quiz";var QUIZ_KEY = "quiz_siondecaroleplay_10_2026-09-11_v1";var ATT_KEY = "quiz_siondecaroleplay_10_att_2026-09-11_v1";var REPORT_ENDPOINT = 'https://script.google.com/macros/s/AKfycbzRYITi7Q4ttOMcqHPBQ_mfc1m-Oyk_ne-7OKeRGbR_WFEUAe9oCKiC9E7f3ymZWR6i/exec';var RAW_QUESTIONS = [{"stem": "A hotel has overbooked, and a guest with a confirmed reservation arrives to find no room available. What is the best immediate response?", "opts": ["Apologize sincerely, explain honestly, and offer a comparable or upgraded room at a partner hotel plus compensation", "Tell the guest it is not the hotel's fault and they should have called ahead", "Ignore the issue and hope the guest does not complain", "Offer only a verbal apology with no further action"], "ci": 0, "exp": "Effective service recovery requires a sincere apology, honesty, and a concrete solution with fair compensation, not blame-shifting or an empty gesture."}, {"stem": "A US company is preparing to negotiate a contract with a business partner in a country where relationship-building typically precedes business discussions. What should the US team do?", "opts": ["Invest time in building rapport and trust with the partner before moving into contract details", "Refuse to adapt to the partner's customs at all", "Assume every culture negotiates exactly the way the US does", "Immediately present the final contract terms and demand a signature"], "ci": 0, "exp": "Successful cross-cultural negotiation requires adapting to local norms, and in cultures that prioritize relationship-building, taking time to build trust first improves the chances of a successful deal."}, {"stem": "A concert venue raises ticket prices by 10%, and total ticket revenue increases as a result. What does this most likely suggest about demand for the tickets?", "opts": ["Demand and price have no relationship at all", "Demand is perfectly elastic", "Supply must have decreased at the exact same time", "Demand is relatively inelastic, since the price increase did not significantly reduce the quantity of tickets sold"], "ci": 3, "exp": "When a price increase leads to higher total revenue, it indicates that quantity demanded did not fall proportionally, which is the definition of relatively inelastic demand."}, {"stem": "A food company discovers a possible contamination issue in a batch of its product that is already on store shelves. What is the most responsible first action?", "opts": ["Issue a voluntary recall and promptly notify regulators and customers", "Publicly deny the possibility to protect the brand's reputation", "Wait to see if any customers complain before doing anything", "Quietly restock shelves with new product without addressing the old batch"], "ci": 0, "exp": "Responsible crisis management requires transparency and swift action &mdash; issuing a recall and notifying regulators and customers &mdash; rather than delay, concealment, or denial."}, {"stem": "A local coffee shop competes against several large chains that recently opened nearby by emphasizing its handcrafted, locally-sourced beans and personalized customer service in all of its marketing. What positioning strategy is the shop using?", "opts": ["Differentiating itself from larger competitors through quality, authenticity, and personalized experience rather than competing on price", "Trying to appear identical to the chains to avoid confusing customers", "Avoiding all forms of marketing altogether", "Attempting to match the chains' prices exactly with no other distinction"], "ci": 0, "exp": "By highlighting distinctive qualities the large chains do not offer, the coffee shop is differentiating its brand rather than competing directly on price or blending in."}, {"stem": "A founder has a promising product idea but very limited funds and no investors yet. What is the best first step before seeking large-scale investment?", "opts": ["Build a minimum viable product (MVP) to test the idea with real customers first", "Skip customer research and mass-produce the product right away", "Immediately hire a full staff and rent a large office", "Apply for a bank loan covering five years of operating expenses"], "ci": 0, "exp": "Building a minimum viable product lets a founder validate demand and gather real feedback with minimal risk before committing to major funding or full-scale production."}, {"stem": "A manager notices that one employee has been underperforming for several weeks. What is the most appropriate first step?", "opts": ["Publicly criticize the employee in a team meeting", "Immediately terminate the employee without any discussion", "Ignore the performance issue indefinitely", "Have a private conversation with the employee to understand the cause and set clear expectations"], "ci": 3, "exp": "Addressing underperformance effectively starts with a private, constructive conversation to understand root causes and clarify expectations, not public criticism, silence, or immediate termination."}, {"stem": "A retailer frequently runs out of a popular product because of long shipping lead times from its single overseas supplier. What is the most effective long-term solution?", "opts": ["Diversify suppliers and/or increase safety stock to buffer against lead-time variability", "Continue ordering the exact same small quantity every time regardless of demand", "Ignore the issue since customers will eventually stop asking for it", "Stop selling the product entirely"], "ci": 0, "exp": "Diversifying suppliers and holding appropriate safety stock directly addresses the root cause of stockouts caused by long and unpredictable lead times."}, {"stem": "A skincare startup wants to reach teenagers and young adults on a limited marketing budget. Which promotional channel is most strategically appropriate?", "opts": ["Mailing paper catalogs to every household regardless of age", "Partnering with social media influencers who are popular with that age group", "Running full-page ads in a national print newspaper", "Sponsoring a radio segment aimed primarily at retirees"], "ci": 1, "exp": "Social media influencer partnerships are typically cost-effective and directly reach the media habits and preferences of teen and young-adult audiences, unlike print, radio aimed at a different demographic, or mass mailings."}, {"stem": "A small business owner notices cash flow is tight even though the company is profitable on paper, because customers are slow to pay their invoices. What is the best strategy to address this?", "opts": ["Tighten accounts receivable practices, such as offering early-payment discounts or shortening payment terms", "Take on a large new loan without changing any collection practices", "Stop invoicing customers altogether", "Ignore the issue since profitability is what matters most"], "ci": 0, "exp": "Since the core problem is slow collections rather than a lack of profit, improving accounts receivable practices directly targets the cash flow gap."}];var N = RAW_QUESTIONS.length;var ORDER_KEY = QUIZ_KEY + '_order_v1';
