var TITLE = "[Both] Korean";var QUIZ_KEY = "quiz_bothkorean_10_2026-09-11_v1";var ATT_KEY = "quiz_bothkorean_10_att_2026-09-11_v1";var REPORT_ENDPOINT = 'https://script.google.com/macros/s/AKfycbzRYITi7Q4ttOMcqHPBQ_mfc1m-Oyk_ne-7OKeRGbR_WFEUAe9oCKiC9E7f3ymZWR6i/exec';var RAW_QUESTIONS = [{"stem": "노래를 듣다.", "opts": ["Give the window.", "Give the song.", "Listen to the window.", "Listen to the song."], "ci": 3, "exp": "\"노래를 듣다.\" means \"Listen to the song.\"", "tag": "Combo", "tagcolor": "#7b61ff", "tts": "노래를 듣다."}, {"stem": "해를 좋아하다.", "opts": ["Know the sun.", "Like the ear.", "Like the sun.", "Know the ear."], "ci": 2, "exp": "\"해를 좋아하다.\" means \"Like the sun.\"", "tag": "Combo", "tagcolor": "#7b61ff", "tts": "해를 좋아하다."}, {"stem": "병원을 무서워하다.", "opts": ["Know the bird.", "Be afraid of the hospital.", "Be afraid of the bird.", "Know the hospital."], "ci": 1, "exp": "\"병원을 무서워하다.\" means \"Be afraid of the hospital.\"", "tag": "Combo", "tagcolor": "#7b61ff", "tts": "병원을 무서워하다."}, {"stem": "창을 붙이다.", "opts": ["Attach the window.", "Prepare the door.", "Prepare the window.", "Attach the door."], "ci": 0, "exp": "\"창을 붙이다.\" means \"Attach the window.\"", "tag": "Combo", "tagcolor": "#7b61ff", "tts": "창을 붙이다."}, {"stem": "구두를 놓다.", "opts": ["Take a photo of the mirror.", "Take a photo of the shoes.", "Put down the shoes.", "Put down the mirror."], "ci": 2, "exp": "\"구두를 놓다.\" means \"Put down the shoes.\"", "tag": "Combo", "tagcolor": "#7b61ff", "tts": "구두를 놓다."}, {"stem": "오리를 따라가다.", "opts": ["Follow the whale.", "Follow the duck.", "Introduce the whale.", "Introduce the duck."], "ci": 1, "exp": "\"오리를 따라가다.\" means \"Follow the duck.\"", "tag": "Combo", "tagcolor": "#7b61ff", "tts": "오리를 따라가다."}, {"stem": "의자를 들다.", "opts": ["Lift the hat.", "Lift the chair.", "Take a photo of the chair.", "Take a photo of the hat."], "ci": 1, "exp": "\"의자를 들다.\" means \"Lift the chair.\"", "tag": "Combo", "tagcolor": "#7b61ff", "tts": "의자를 들다."}, {"stem": "구두를 받다.", "opts": ["Throw away the coffee.", "Receive the shoes.", "Receive the coffee.", "Throw away the shoes."], "ci": 1, "exp": "\"구두를 받다.\" means \"Receive the shoes.\"", "tag": "Combo", "tagcolor": "#7b61ff", "tts": "구두를 받다."}, {"stem": "달을 보다.", "opts": ["See the lake.", "See the moon.", "Know the lake.", "Know the moon."], "ci": 1, "exp": "\"달을 보다.\" means \"See the moon.\"", "tag": "Combo", "tagcolor": "#7b61ff", "tts": "달을 보다."}, {"stem": "가게를 꾸미다.", "opts": ["Decorate the house.", "Like the house.", "Like the store.", "Decorate the store."], "ci": 3, "exp": "\"가게를 꾸미다.\" means \"Decorate the store.\"", "tag": "Combo", "tagcolor": "#7b61ff", "tts": "가게를 꾸미다."}];var N = RAW_QUESTIONS.length;var ORDER_KEY = QUIZ_KEY + '_order_v1';
